package com.example.ps08209duanmau.DAO;
...
import com.example.ps08209duanmau.Database.DbHelper;
...
public class NguoiDungDAO {
    ...
    public static final String strInsert1 =
            "Insert into " + TABLE_NAME + " Values('admin','admin','','')";
    public static final String strInsert2 =
            "Insert into " + TABLE_NAME + " Values('thientt','123','','')";
